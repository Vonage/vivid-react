...
|----------------|--------------|-----------------|
| VwcAccordion | @vonage/vwc-accordion | ^2.18.1 |
| VwcAudio | @vonage/vwc-audio | ^2.18.1 |
| VwcBadge | @vonage/vwc-badge | ^2.18.1 |
...
| VwcCircularProgress | @vonage/vwc-circular-progress | ^2.18.1 |
| VwcDataGrid | @vonage/vwc-data-grid | ^2.18.1 |
| VwcDatepicker | @vonage/vwc-datepicker | ^2.18.1 |
| VwcDialog | @vonage/vwc-dialog | ^2.18.1 |
| VwcDrawer | @vonage/vwc-drawer | ^2.18.1 |
| VwcDropdown | @vonage/vwc-dropdown | ^2.18.1 |
| VwcEmptyState | @vonage/vwc-empty-state | ^2.18.1 |
| VwcExpansionPanel | @vonage/vwc-expansion-panel | ^2.18.1 |
| VwcFab | @vonage/vwc-fab | ^2.18.1 |
| VwcFilePicker | @vonage/vwc-file-picker | ^2.18.1 |
| VwcFormfield | @vonage/vwc-formfield | ^2.18.1 |
| VwcHelperMessage | @vonage/vwc-helper-message | ^2.18.1 |
| VwcIcon | @vonage/vwc-icon | ^2.18.1 |
| VwcIconButton | @vonage/vwc-icon-button | ^2.18.1 |
| VwcIconButtonToggle | @vonage/vwc-icon-button-toggle | ^2.18.1 |
| VwcInline | @vonage/vwc-inline | ^2.18.1 |
| VwcKeypad | @vonage/vwc-keypad | ^2.18.1 |
| VwcLinearProgress | @vonage/vwc-linear-progress | ^2.18.1 |
| VwcList | @vonage/vwc-list | ^2.18.1 |
| VwcMediaController | @vonage/vwc-media-controller | ^2.18.1 |
| VwcMenu | @vonage/vwc-menu | ^2.18.1 |
| VwcNotchedOutline | @vonage/vwc-notched-outline | ^2.18.1 |
| VwcNote | @vonage/vwc-note | ^2.18.1 |
| VwcPagination | @vonage/vwc-pagination | ^2.18.1 |
| VwcRadio | @vonage/vwc-radio | ^2.18.1 |
| VwcSchemeSelect | @vonage/vwc-scheme-select | ^2.18.1 |
| VwcSelect | @vonage/vwc-select | ^2.18.1 |
| VwcSideDrawer | @vonage/vwc-side-drawer | ^2.18.1 |
| VwcSlider | @vonage/vwc-slider | ^2.18.1 |
| VwcSnackbar | @vonage/vwc-snackbar | ^2.18.1 |
| VwcSurface | @vonage/vwc-surface | ^2.18.1 |
| VwcSwitch | @vonage/vwc-switch | ^2.18.1 |
| VwcTabBar | @vonage/vwc-tab-bar | ^2.18.1 |
| VwcText | @vonage/vwc-text | ^2.18.1 |
| VwcTextarea | @vonage/vwc-textarea | ^2.18.1 |
| VwcTextfield | @vonage/vwc-textfield | ^2.18.1 |
| VwcThemeSwitch | @vonage/vwc-theme-switch | ^2.18.1 |
| VwcTopAppBar | @vonage/vwc-top-app-bar | ^2.18.1 |
| VwcTopAppBarFixed | @vonage/vwc-top-app-bar-fixed | ^2.18.1 |
