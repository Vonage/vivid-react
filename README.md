...
|----------------|--------------|-----------------|
| VwcAccordion | @vonage/vwc-accordion | ^2.17.0 |
| VwcAudio | @vonage/vwc-audio | ^2.17.0 |
| VwcBadge | @vonage/vwc-badge | ^2.17.0 |
| VwcBanner | @vonage/vwc-banner | ^2.17.0 |
| VwcButton | @vonage/vwc-button | ^2.17.0 |
| VwcButtonToggleGroup | @vonage/vwc-button-toggle-group | ^2.17.0 |
| VwcCalendar | @vonage/vwc-calendar | ^2.17.0 |
| VwcCarousel | @vonage/vwc-carousel | ^2.17.0 |
| VwcCheckbox | @vonage/vwc-checkbox | ^2.17.0 |
| VwcChips | @vonage/vwc-chips | ^2.17.0 |
| VwcCircularProgress | @vonage/vwc-circular-progress | ^2.17.0 |
| VwcDataGrid | @vonage/vwc-data-grid | ^2.17.0 |
| VwcDatepicker | @vonage/vwc-datepicker | ^2.17.0 |
...
| VwcHelperMessage | @vonage/vwc-helper-message | ^2.17.0 |
| VwcIcon | @vonage/vwc-icon | ^2.17.0 |
| VwcIconButton | @vonage/vwc-icon-button | ^2.17.0 |
| VwcIconButtonToggle | @vonage/vwc-icon-button-toggle | ^2.17.0 |
| VwcInline | @vonage/vwc-inline | ^2.17.0 |
| VwcKeypad | @vonage/vwc-keypad | ^2.17.0 |
| VwcLinearProgress | @vonage/vwc-linear-progress | ^2.17.0 |
| VwcList | @vonage/vwc-list | ^2.17.0 |
| VwcMediaController | @vonage/vwc-media-controller | ^2.17.0 |
| VwcMenu | @vonage/vwc-menu | ^2.17.0 |
| VwcNotchedOutline | @vonage/vwc-notched-outline | ^2.17.0 |
| VwcNote | @vonage/vwc-note | ^2.17.0 |
| VwcPagination | @vonage/vwc-pagination | ^2.17.0 |
...
| VwcTextfield | @vonage/vwc-textfield | ^2.17.0 |
| VwcThemeSwitch | @vonage/vwc-theme-switch | ^2.17.0 |
| VwcTopAppBar | @vonage/vwc-top-app-bar | ^2.17.0 |
| VwcTopAppBarFixed | @vonage/vwc-top-app-bar-fixed | ^2.17.0 |
