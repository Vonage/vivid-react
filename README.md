...
|----------------|--------------|-----------------|
| VwcAudio | @vonage/vwc-audio | ^2.6.2 |
| VwcBadge | @vonage/vwc-badge | ^2.6.2 |
| VwcButton | @vonage/vwc-button | ^2.6.2 |
| VwcCalendar | @vonage/vwc-calendar | ^2.6.2 |
| VwcCarousel | @vonage/vwc-carousel | ^2.6.2 |
| VwcCheckbox | @vonage/vwc-checkbox | ^2.6.2 |
| VwcChips | @vonage/vwc-chips | ^2.6.2 |
| VwcCircularProgress | @vonage/vwc-circular-progress | ^2.6.2 |
| VwcDataGrid | @vonage/vwc-data-grid | ^2.6.2 |
| VwcDatepicker | @vonage/vwc-datepicker | ^2.6.2 |
| VwcDialog | @vonage/vwc-dialog | ^2.6.2 |
| VwcDrawer | @vonage/vwc-drawer | ^2.6.2 |
| VwcExpansionPanel | @vonage/vwc-expansion-panel | ^2.6.2 |
| VwcFab | @vonage/vwc-fab | ^2.6.2 |
| VwcFilePicker | @vonage/vwc-file-picker | ^2.6.2 |
| VwcFormfield | @vonage/vwc-formfield | ^2.6.2 |
| VwcHelperMessage | @vonage/vwc-helper-message | ^2.6.2 |
| VwcIcon | @vonage/vwc-icon | ^2.6.2 |
| VwcIconButton | @vonage/vwc-icon-button | ^2.6.2 |
| VwcIconButtonToggle | @vonage/vwc-icon-button-toggle | ^2.6.2 |
| VwcInline | @vonage/vwc-inline | ^2.6.2 |
| VwcKeypad | @vonage/vwc-keypad | ^2.6.2 |
| VwcLinearProgress | @vonage/vwc-linear-progress | ^2.6.2 |
| VwcList | @vonage/vwc-list | ^2.6.2 |
| VwcMediaController | @vonage/vwc-media-controller | ^2.6.2 |
| VwcMenu | @vonage/vwc-menu | ^2.6.2 |
| VwcNotchedOutline | @vonage/vwc-notched-outline | ^2.6.2 |
| VwcNote | @vonage/vwc-note | ^2.6.2 |
| VwcPagination | @vonage/vwc-pagination | ^2.6.2 |
| VwcRadio | @vonage/vwc-radio | ^2.6.2 |
| VwcSchemeSelect | @vonage/vwc-scheme-select | ^2.6.2 |
| VwcSelect | @vonage/vwc-select | ^2.6.2 |
| VwcSlider | @vonage/vwc-slider | ^2.6.2 |
| VwcSwitch | @vonage/vwc-switch | ^2.6.2 |
| VwcTabBar | @vonage/vwc-tab-bar | ^2.6.2 |
| VwcTextarea | @vonage/vwc-textarea | ^2.6.2 |
| VwcTextfield | @vonage/vwc-textfield | ^2.6.2 |
| VwcThemeSwitch | @vonage/vwc-theme-switch | ^2.6.2 |
| VwcToggleButtonsGroup | @vonage/vwc-toggle-buttons-group | ^2.6.2 |
| VwcTopAppBar | @vonage/vwc-top-app-bar | ^2.6.2 |
| VwcTopAppBarFixed | @vonage/vwc-top-app-bar-fixed | ^2.6.2 |
