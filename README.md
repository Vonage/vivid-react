...
|----------------|--------------|-----------------|
| VwcAudio | @vonage/vwc-audio | ^2.0.1 |
| VwcBadge | @vonage/vwc-badge | ^2.0.2 |
| VwcButton | @vonage/vwc-button | ^2.0.2 |
| VwcCalendar | @vonage/vwc-calendar | ^2.0.1 |
| VwcCarousel | @vonage/vwc-carousel | ^2.0.1 |
| VwcCheckbox | @vonage/vwc-checkbox | ^2.0.1 |
| VwcChips | @vonage/vwc-chips | ^1.1.3 |
| VwcCircularProgress | @vonage/vwc-circular-progress | ^2.0.2 |
| VwcDatepicker | @vonage/vwc-datepicker | ^2.0.1 |
| VwcDialog | @vonage/vwc-dialog | ^2.0.1 |
| VwcDrawer | @vonage/vwc-drawer | ^2.0.1 |
| VwcExpansionPanel | @vonage/vwc-expansion-panel | ^2.0.1 |
| VwcFab | @vonage/vwc-fab | ^2.0.1 |
| VwcFilePicker | @vonage/vwc-file-picker | ^2.0.1 |
| VwcFormfield | @vonage/vwc-formfield | ^2.0.2 |
| VwcHelperMessage | @vonage/vwc-helper-message | ^2.0.2 |
| VwcIcon | @vonage/vwc-icon | ^2.0.2 |
| VwcIconButton | @vonage/vwc-icon-button | ^2.0.1 |
| VwcIconButtonToggle | @vonage/vwc-icon-button-toggle | ^2.0.1 |
| VwcInline | @vonage/vwc-inline | ^2.0.1 |
| VwcKeypad | @vonage/vwc-keypad | ^2.0.1 |
| VwcLinearProgress | @vonage/vwc-linear-progress | ^2.0.1 |
| VwcList | @vonage/vwc-list | ^2.0.1 |
| VwcMediaController | @vonage/vwc-media-controller | ^2.0.1 |
| VwcMenu | @vonage/vwc-menu | ^2.0.1 |
| VwcNotchedOutline | @vonage/vwc-notched-outline | ^2.0.2 |
| VwcNote | @vonage/vwc-note | ^2.0.2 |
| VwcRadio | @vonage/vwc-radio | ^2.0.1 |
| VwcRelativeTime | @vonage/vwc-relative-time | ^1.3.1 |
| VwcSchemeSelect | @vonage/vwc-scheme-select | ^2.0.1 |
| VwcSelect | @vonage/vwc-select | ^2.0.1 |
| VwcSlider | @vonage/vwc-slider | ^2.0.1 |
| VwcSwitch | @vonage/vwc-switch | ^2.0.1 |
| VwcTabBar | @vonage/vwc-tab-bar | ^2.0.1 |
