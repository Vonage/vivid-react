...
|----------------|--------------|-----------------|
| VwcAudio | @vonage/vwc-audio | ^2.3.0 |
| VwcBadge | @vonage/vwc-badge | ^2.3.0 |
| VwcButton | @vonage/vwc-button | ^2.3.0 |
| VwcCalendar | @vonage/vwc-calendar | ^2.3.0 |
| VwcCarousel | @vonage/vwc-carousel | ^2.3.0 |
...
| VwcFilePicker | @vonage/vwc-file-picker | ^2.3.0 |
| VwcFormfield | @vonage/vwc-formfield | ^2.3.0 |
| VwcHelperMessage | @vonage/vwc-helper-message | ^2.3.0 |
| VwcIcon | @vonage/vwc-icon | ^2.3.0 |
| VwcIconButton | @vonage/vwc-icon-button | ^2.3.0 |
| VwcIconButtonToggle | @vonage/vwc-icon-button-toggle | ^2.3.0 |
| VwcInline | @vonage/vwc-inline | ^2.3.0 |
| VwcKeypad | @vonage/vwc-keypad | ^2.3.0 |
| VwcLinearProgress | @vonage/vwc-linear-progress | ^2.3.0 |
| VwcList | @vonage/vwc-list | ^2.3.0 |
| VwcMediaController | @vonage/vwc-media-controller | ^2.3.0 |
| VwcMenu | @vonage/vwc-menu | ^2.3.0 |
| VwcNotchedOutline | @vonage/vwc-notched-outline | ^2.3.0 |
| VwcNote | @vonage/vwc-note | ^2.3.0 |
| VwcRadio | @vonage/vwc-radio | ^2.3.0 |
| VwcRelativeTime | @vonage/vwc-relative-time | ^1.3.1 |
| VwcSchemeSelect | @vonage/vwc-scheme-select | ^2.3.0 |
| VwcSelect | @vonage/vwc-select | ^2.3.0 |
| VwcSlider | @vonage/vwc-slider | ^2.3.0 |
| VwcSwitch | @vonage/vwc-switch | ^2.3.0 |
| VwcTabBar | @vonage/vwc-tab-bar | ^2.3.0 |
| VwcTextarea | @vonage/vwc-textarea | ^2.3.0 |
| VwcTextfield | @vonage/vwc-textfield | ^2.3.0 |
| VwcThemeSwitch | @vonage/vwc-theme-switch | ^2.3.0 |
| VwcTopAppBar | @vonage/vwc-top-app-bar | ^2.3.0 |
| VwcTopAppBarFixed | @vonage/vwc-top-app-bar-fixed | ^2.3.0 |
