...
const compoundComponent = (baseName) => ([compositeName, defaultProps]) =>
...
const compoundComponents = (compoundComponentsMap) => (baseName) => Object
  .entries(compoundComponentsMap[baseName] || {})
  .map(compoundComponent(baseName))
  .join('\n\n')
